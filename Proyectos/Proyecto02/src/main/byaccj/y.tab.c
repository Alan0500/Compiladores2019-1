...
{
  "$end", "error", "$undefined", "NUMERO", "TRUE", "FALSE", "SALTO",
  "AND", "FROM", "ENTERO", "REAL", "INDENTA", "DEINDENTA", "ELIF", "OR",
  "IF", "PRINT", "RETURN", "MAS", "MENOS", "MULT", "DIV", "EXP", "MOD",
  "MAYOR", "MENOR", "NOT", "WHILE", "FOR", "ELSE", "CADENA", "MAYORIG",
  "MENOSIG", "IGUAL", "DIST", "MASIG", "MENORIG", "IGUALIG", "PARIZQ",
  "PARDER", "DOSPUNTOS", "PUNTOCOMA", "IDENTIFICADOR", "$accept",
